-- ============================================================================
-- THE GRAND MALL — SEED ALL 43 CANONICAL PROJECT COUPONS INTO SUPABASE
-- ============================================================================
...
-- 1. Ensure RLS Policy allows secure public/customer reading of active coupons
...
-- 2. Insert / Upsert All 43 Exact Canonical Coupons
...
('70000000-0000-0000-0000-000000000021', 'DOMINOSBOGO', 'Buy 1 Get 1 Free Gourmet Pizza Slice', 'flat', 399.00, 1200, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),

-- Fine Jewelry & Watches
('70000000-0000-0000-0000-000000000022', 'TIFFANYDIAMOND', 'Flat ₹15,000 Off Fine Jewelry', 'flat', 15000.00, 400, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000023', 'CARTIERLUX20', 'Flat ₹20,000 Off Diamond Jewelry', 'flat', 20000.00, 350, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000024', 'BVLGARI25', 'Flat ₹25,000 Off Serpenti & B.zero1', 'flat', 25000.00, 380, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000025', 'SWAROVSKI20', '20% Off Crystal Jewelry & Sets', 'percentage', 20.00, 900, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000026', 'TANISHQGOLD', 'Flat ₹10,000 Off Kundan & 22k Gold', 'flat', 10000.00, 600, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000027', 'MALABARVIP', 'Flat ₹12,000 Off Solitaire Diamonds', 'flat', 12000.00, 500, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000028', 'ROLEX5000', 'Flat ₹5,000 Off Luxury Timepieces', 'flat', 5000.00, 250, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000029', 'OMEGACHRONO', 'Flat ₹15,000 Off Speedmaster & Seamaster', 'flat', 15000.00, 300, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000030', 'TAGHEUERVIP', 'Flat ₹10,000 Off Carrera Chronographs', 'flat', 10000.00, 350, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000031', 'TISSOTSWISS', '15% Off Tissot PRX Powermatic 80', 'percentage', 15.00, 950, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000032', 'NEBULA18K', 'Flat ₹20,000 Off 18k Solid Gold Watches', 'flat', 20000.00, 300, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),

-- Eyewear & Optics
('70000000-0000-0000-0000-000000000033', 'RAYBAN20', '20% Off Designer Eyewear', 'percentage', 20.00, 1100, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000034', 'SUNGLASSHUT15', '15% Off Versace & Designer Shades', 'percentage', 15.00, 850, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000035', 'OAKLEYSPORT20', '20% Off Polarized & Prizm Vision', 'percentage', 20.00, 750, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000036', 'TOMFORDVIP', 'Flat ₹5,000 Off Luxury Eyewear', 'flat', 5000.00, 400, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000037', 'LENSKART500', 'Flat ₹500 Off John Jacobs Titanium', 'flat', 500.00, 1500, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),

-- Electronics, Beauty & Entertainment
('70000000-0000-0000-0000-000000000038', 'APPLEVIP5', 'Flat ₹5,000 Off Apple Watch & Vision', 'flat', 5000.00, 420, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000039', 'APPLECARE500', 'Flat ₹500 Off AppleCare Protection Plan', 'flat', 500.00, 500, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000040', 'SEPHORA10', '10% Off Premium Beauty & Fragrances', 'percentage', 10.00, 800, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000041', 'PVRCOMBO', 'Flat ₹150 Off Caramel Popcorn Combo', 'flat', 150.00, 1000, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),

-- Mall-Wide Concierge & VIP Coupons
('70000000-0000-0000-0000-000000000042', 'GRANDMALL20', '20% Off Concierge First Order', 'percentage', 20.00, 3000, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW()),
('70000000-0000-0000-0000-000000000043', 'MALLVIP25', 'Flat 25% Off VIP Mall Shopping', 'percentage', 25.00, 2500, true, NOW() - INTERVAL '10 days', NOW() + INTERVAL '180 days', NOW())
...
UPDATE public.coupons c SET brand_id = b.id FROM public.brands b WHERE c.code = 'HMESSENTIALS20' AND b.name = 'H&M Everyday Fashion';
...
UPDATE public.coupons c SET brand_id = b.id FROM public.brands b WHERE c.code = 'COFFEEDAY100' AND b.name = 'Coffee Day';
...
UPDATE public.coupons c SET brand_id = b.id FROM public.brands b WHERE c.code = 'DOMINOSBOGO' AND b.name = 'Domino''s';
...
UPDATE public.coupons c SET brand_id = b.id FROM public.brands b WHERE c.code = 'SEPHORA10' AND b.name = 'Sephora';
UPDATE public.coupons c SET brand_id = b.id FROM public.brands b WHERE c.code = 'PVRCOMBO' AND b.name = 'PVR Cinemas';
